...
export function ProductsIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M4 8l8-4.5L20 8v8l-8 4.5L4 16V8z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path d="M4 8l8 4.5L20 8M12 12.5V21" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
...
export function TagIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M11.5 3.5H5a1.5 1.5 0 0 0-1.5 1.5v6.5L13 21l7-7-9.5-9.5z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export function ImageStackIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <rect x="5.5" y="6.5" width="14" height="11" rx="1.4" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="9.5" cy="10.5" r="1.3" stroke="currentColor" strokeWidth="1.4" />
      <path d="M7 15l3.2-3 3 2.6 2.3-2.1 3.5 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
