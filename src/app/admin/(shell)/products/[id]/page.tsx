  ...
  return (
    <div className="px-4 py-4">
      <div className="mb-4 flex items-center gap-2">
        <Link href="/admin/products" aria-label="Назад к товарам" className="flex h-11 w-11 items-center justify-center -ml-2">
          <ChevronLeftIcon className="h-5 w-5 text-cream" />
        </Link>
        <h1 className="text-lg text-cream">
          {product.name === "Без названия" ? "Новый товар" : product.name}
        </h1>
      </div>
