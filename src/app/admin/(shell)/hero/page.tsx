...
export default async function AdminHeroPage() {
  ...
  return (
    <div className="px-4 py-4 pb-24">
      <h1 className="mb-3 text-xl text-cream">Оформление</h1>

      <section>
        <p className="mb-2 text-sm text-muted">Акции месяца — баннер на главной</p>
      ...
      <section className="mt-6">
        <div className="mb-2 flex items-center justify-between">
          <p className="text-sm text-muted">Слайды на главной</p>
        ...
        <div className="flex flex-col gap-3">
          {slides.length === 0 && <p className="text-sm text-muted">Слайдов пока нет.</p>}
          {slides.map((s, i) => (
